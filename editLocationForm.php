        ...
        <div class="content">
            <div class="container">
                ...
                <form action="editLocation.php" method="POST" class="form-horizontal">
                    <input type="hidden" name="id" value="<?php echo isset($row['locationID']) ? $row['locationID'] : ''; ?>" /><!--location id-->
                    <div class="form-group">
                        <label for="Name" class="col-md-2 control-label">Name</label><!--label-->
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="Name" name="Name" value="<?php echo isset($row['Name']) ? $row['Name'] : ''; ?>" /><!--input with current data from database-->
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="Address" name="Address" value="<?php echo isset($row['Address']) ? $row['Address'] : ''; ?>" /><!--input with current data from database-->
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="ManagerFName" name="ManagerFName" value="<?php echo isset($row['ManagerFName']) ? $row['ManagerFName'] : ''; ?>" /><!--input with current data from database-->
                        </div> 
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="ManagerLName" name="ManagerLName" value="<?php echo isset($row['ManagerLName']) ? $row['ManagerLName'] : ''; ?>" /><!--input with current data from database-->
                        </div>
                        <div class="col-md-4">
                            <span id="mNameError" class="error"></span><!--error message for invalid input-->
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="ManagerEmail" name="ManagerEmail" value="<?php echo isset($row['ManagerEmail']) ? $row['ManagerEmail'] : ''; ?>" /><!--input with current data from database-->
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="number" class="form-control" id="ManagerNumber" name="ManagerNumber" value="<?php echo isset($row['ManagerNumber']) ? $row['ManagerNumber'] : ''; ?>" /><!--input with current data from database-->
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="number" class="form-control" id="MaxCapacity" name="MaxCapacity" value="<?php echo isset($row['MaxCapacity']) ? $row['MaxCapacity'] : ''; ?>" /><!--input with current data from database-->
                        </div>
                        <div class="col-md-4">
